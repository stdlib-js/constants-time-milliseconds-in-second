...
```javascript
import MILLISECONDS_IN_SECOND from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-second@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-time-milliseconds-in-second/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/constants-time-milliseconds-in-second/actions/workflows/test.yml?query=branch:v0.2.0
